...
//2018A7PS0372H  Nimish Gupta
//2017A7PS1479H  Rahul Mehndiratta
//2018A7PS0315H  Aditya Sharma
#include<bits/stdc++.h>
#include<fstream>
...
vector<pair<string,int>> parser_input;
...
void printer(string lexeme, int token_number, int line_number)
{
   ...
   temp.first=lexeme;
   temp.second=token_number;
   parser_input.push_back(temp);
}

vector<pair<string,int>> Lex()
{
   fp = freopen("testcase1.txt", "r", stdin); //Open file that contains the input program to be scanned
